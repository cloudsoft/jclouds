 ...
 */
package org.jclouds.openstack.keystone.v3.handlers;
...
public class RetryOnRenew implements HttpRetryHandler {
   ...
   private final LoadingCache<Credentials, Token> authenticationResponseCache;

   private final BackoffLimitedRetryHandler backoffHandler;

   @Inject
   protected RetryOnRenew(LoadingCache<Credentials, Token> authenticationResponseCache,
