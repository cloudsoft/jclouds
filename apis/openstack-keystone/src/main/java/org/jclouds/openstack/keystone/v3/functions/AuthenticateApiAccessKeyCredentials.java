...
public class AuthenticateApiAccessKeyCredentials extends BaseAuthenticator<ApiAccessKeyCredentials> {
   ...
   @Override
   protected Token authenticateWithTenantName(Optional<String> tenantName, ApiAccessKeyCredentials apiAccessKeyCredentials) {
      return api.passwordAuthenticationWithUnscopedAuthorization(tenantName.orNull(), apiAccessKeyCredentials);
   }

   @Override
   protected Token authenticateWithTenantId(Optional<String> tenantId, ApiAccessKeyCredentials apiAccessKeyCredentials) {
      return api.passwordAuthenticationWithUnscopedAuthorization(tenantId.orNull(), apiAccessKeyCredentials);
   }
